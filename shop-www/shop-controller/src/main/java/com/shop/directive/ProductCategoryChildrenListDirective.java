...
public class ProductCategoryChildrenListDirective extends BaseDirective {
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars,
        ...
        //获取参数
        Integer paraentId = getParameter(params,"parentId",Integer.class);
        Integer limit = getParameter(params,"limit",Integer.class);
        //获取结果
        List<ProductCategory> productCategories = productCategoryService.findChildrenList(paraentId,limit);
        //输出
